    ...
    <div class="navbar-menu-wrapper d-flex align-items-top"> 
      <ul class="navbar-nav">
        <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
          <h1 class="welcome-text">Bienvenue, <span class="text-black fw-bold">{{auth()->user()->nom_prenoms ?? ""}}</span></h1>
        ...
        <li class="nav-item dropdown d-none d-lg-block user-dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
            <div class="dropdown-header text-center">
              ...
              <p class="mb-1 mt-3 font-weight-semibold">{{auth()->user()->nom_prenoms ?? ""}}</p>
              <p class="fw-light text-muted mb-0">{{auth()->user()->mail ?? ""}}</p>
            </div>
            ...
            <a class="dropdown-item" href="{{route('logout')}}"><i class="dropdown-item-icon mdi mdi-power text-primary me-2"></i>Se deconnecter</a>
          </div>
        </li>
      </ul>
